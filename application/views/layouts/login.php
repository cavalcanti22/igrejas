...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="http://www.urbanui.com/turbo/<?=base_url()?>assets/admin/img/apple-icon.png" />
    ...
    <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url()?>">Gemini Web Login</a>
            </div>
        </div>
    </nav>
