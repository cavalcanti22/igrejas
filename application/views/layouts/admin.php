...
<body class="boxed-layout">
    <div class="wrapper">
        <div class="sidebar">
            <div class="logo">
                <a  class="simple-text" href="<?=base_url()?>Welcome">
                ...
                <ul class="nav">
                    ...
                    <li>
                        ...
                        <div class="collapse" id="usuarios" aria-expanded="false" style="height: 0px;">
                            <ul class="nav">
                                <li>
                                    <a  href="<?=base_url()?>aprovadas" >
                                        <p>Aprovadas
                                        </p>
                                    </a>
                                </li> 
                                <li>
                                    <a  href="<?=base_url()?>pendentes" >
                                        <p>Pendentes
                                        </p>
                                    </a>
                                </li> 
                    ...
                    <li>
                        <a data-toggle="collapse" href="#imagens" class="collapsed" aria-expanded="false">
                            <i class="material-icons">photo</i>
                            <p>Imagens Galeria
                                <b class="caret"></b>
                            </p>
                        </a>
                        <div class="collapse" id="imagens" aria-expanded="false" style="height: 0px;">
                            <ul class="nav">
                                <li>
                                    <a  href="<?=base_url()?>Imagens" >
                                        <p>Listar Imagens
                                        </p>
                                    </a>
                                </li> 
                                <li>
                                    <a  href="<?=base_url()?>Imagens/add" >
                                        <p>Add Imagem
                                        </p>
                                    </a>
                                </li> 
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="notification"><?php print_r($totalpendentes); ?></span>
                                ...
                                <ul class="dropdown-menu">
                                   <li>
                                    <a href="<?=base_url()?>pendentes" style="text-decoration: underline;">Igrejas Pendentes:</a>
                                </li>
                                <?php foreach ($igrejas as $igreja): ?>
                                 <?php if ($igreja->status == 0): ?>
                                    <li>
                                        <a href="<?=base_url()?>Igrejas/getOne/<?=md5($igreja->id) ?>">* <?=$igreja->name?></a>
                                    </li>
                                <?php endif ?>
                            <?php endforeach ?>
                        </ul>
