          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-content">
                <h4 class="card-title">Igrejas Aprovadas</h4>
                <div class="toolbar">
                        ...
                        <?php if ($igreja->status == 1): ?>
                          <tr>
                            ...
                            <td class="text-right">
                             ...
                             <a href="<?=base_url()?>Igrejas/removeAprovada/<?=md5($igreja->id)?>/<?=limpar($igreja->name) ?>" class="btn btn-simple btn-danger btn-icon"><i class="material-icons">close</i></a>
                           </td>
                         </tr>
                       <?php endif ?>
                     <?php endforeach ?>
